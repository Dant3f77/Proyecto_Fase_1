...
{
    public class MantenimientoCarreraVir
    {
        ...
        {
            Conectar();
            SqlCommand comando = new SqlCommand("insert into Tablet_Virtual(Carrera,Asignatura,Duracion,Descripcion) values(@Carrera, @Asignatura, @Duracion, @Descripcion)", con);
        ...
        {
            Conectar();
            List<Carreras> Table_Virtual = new List<Carreras>();

            SqlCommand com = new SqlCommand("select Carrera,Asignatura,Duracion,Descripcion from Table_Virtual", con);
            con.Open();
